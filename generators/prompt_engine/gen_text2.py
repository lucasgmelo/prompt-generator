...
def chatgpt_gen_prompts_list(num_ideas, themes_path, control_path, num_keywords=3, max_chars=30, ideas_per_index=6):
    ...
    with open('C:/LUCAS/UFPE/5o_PERIODO/Multimidia/prompt-api/generators/prompt_engine/templates/txt/outputs.txt', 'a') as file:
...
if __name__ == '__main__':
    ...
    ideas = chatgpt_gen_prompts_list(num_ideas, themes_path, control_path, num_keywords, max_chars, ideas_per_index=6)